...
import {
	generateMarkdownColors,
	generateAlternateMarkdownColors as generateMutedPunctuationMarkdownColors,
} from "./markdown";
...
export function generateTextMateTheme(syntax: SyntaxColors, config: Config) {
	...
	const textMateTheme = {
		tokenColors: [
			...
			tok(
				"Powershell Variable/Storage Scopes",
				["storage.modifier.scope.powershell", "support.variable.drive.powershell"],
				syntax.green,
				"underline",
			),
			tok(
				"Powershell Special/Built-In Variables",
				[
			...
			tok(
				...
				["keyword.operator.comparison.powershell", "keyword.operator.logical.powershell"],
				syntax.lightGreen,
			),
			tok(
				"Powershell Comment Keywords",
			...
			tok(
				"JSX - Embedded Code",
				["punctuation.section.embedded.begin.js", "punctuation.section.embedded.end.js"],
				syntax.orange,
				"bold",
			),
			tok("JSX - Attributes", "entity.other.attribute-name.js", syntax.violet, "italic"),
			//
			// TS
			//
			tok(
			...
			// HTML
			//
			tok("HTML - Tags", "entity.name.tag.html", syntax.pink),
			tok(
				"HTML - IDs",
				[
			...
			tok("CSS - Media Query Types", ["support.constant.media.css"], syntax.violet),
			//
			// SCSS
			//
			{
			...
			tok(
				"XML - Attributes",
				["entity.other.attribute-name.xml", "entity.other.attribute-name.localname.xml"],
				syntax.cyan,
				"italic",
			),
			...
			tok(
				"Asciidoc - Ruler",
				"constant.other.symbol.horizontal-rule.asciidoc",
				syntax.orange,
				"bold underline",
			),
			//
